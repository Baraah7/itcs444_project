...
- **Status updates**: Users notified when rental status changes (approved, checked out, returned)
...
- `approval` - Rental status change (approved, checked out, returned, cancelled)
