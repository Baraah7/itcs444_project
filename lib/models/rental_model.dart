...
class Rental {
  ...
  // Calculate days remaining (only for picked up status)
  ...
  // Get days since pickup (for picked up status)
  ...
  String get statusText {
    switch (status) {
      ...
      case 'approved':
        return 'Approved';
      case 'checked_out':
        return isOverdue ? 'Overdue' : 'Picked Up';
      case 'returned':
        return 'Returned';
      case 'cancelled':
        return 'Cancelled';
  ...
  // Check if rental can be picked up (only approved)
  bool get canBeCheckedOut {
    return status == 'approved';
  }

  // Check if rental can be marked as returned (only picked up)
  ...
  // Check if rental is active (approved or picked up)
  bool get isActive {
